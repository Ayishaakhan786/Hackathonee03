...
<div className="font-[sans-serif] max-w-[410px] h-auto p-6 rounded-lg mx-auto shadow-[0_6px_18px_-6px_rgba(193,195,248)] bg-white relative mt-12">
  ...
  {/* seventh secton */}
  <section className="food-section mt-6 relative">
  {/* Image */}
  ...
  <div className="food-content absolute top-1/2 right-8 transform -translate-y-1/2 text-right text-white">
    <h4 className="text-sm font-bold italic text-orange-400">Restaurant Active Process</h4>
    <h1 className="text-3xl font-bold mt-2 text-orange-500">
      We <span className="text-white">Document Every Food <br/>Bean Process
      until it is saved</span>
    </h1>
    ...
    <div className="buttons mt-6 flex gap-4 justify-end">
      <button className="text-white px-4 py-2 rounded-full border-2 border-orange-500 hover:bg-gray-900">Read More</button>
      <button className="flex items-center text-white px-4 py-2 rounded-full">
